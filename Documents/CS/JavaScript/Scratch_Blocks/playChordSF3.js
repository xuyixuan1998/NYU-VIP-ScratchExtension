(function (ext) {
  ...
  "xylophone"
        ...
        ext.wait = function () {
            ...
            //                        if (currentTime != 0) {
            //
            //                            while (ac.currentTime < time + sched[i].time) {
            //                                console.log("waiting...");
            //                            }
            //                        }
            //
            //
            //                        piano.play(currentNote)
            //                    }
            //
            //            })
            ...
            Soundfont.instrument(ac, instrument).then(function (piano) {
                ...
                for (i = 0; i < sched.length; i++) {
                    console.log("length is " + sched.length);
                    currentNote = sched[i].note;
                    currentTime = sched[i].time;
                    console.log(currentNote);
                    time = ac.currentTime;
                    if (currentTime != 0) {
